...
const optimizedDailySchedule = [
  ...
  },
  {
    ...
    events: [["출퇴근 30분", "토익스피킹 답변 구조·필수 표현 소리 내어 연습"], ["19:00–21:00", "헬스·샤워·저녁"], ["21:30–21:50", "이번 주 회로 개념과 계산 복습"], ["21:50–22:20", "전동킥보드 강의 1강"], ["22:20–22:25", "배운 것 기록"]],
  },
  {
    day: "화요일", type: "강의·HW 실습", focus: "주중 첫 집중 학습",
    events: [["출퇴근 30분", "토익스피킹 Part 1·2 녹음과 발음 교정"], ["19:00–20:00", "저녁과 휴식"], ["20:00–20:40", "전동킥보드 강의와 핵심 노트"], ["20:50–21:40", "관련 계산·회로·Firmware 실습"], ["21:40–21:50", "직접 한 것과 결과 기록"]],
  },
  {
    day: "수요일", type: "회복·강의 복습", focus: "강의 개념을 내 말로 정리",
    events: [["출퇴근 30분", "토익스피킹 Part 3·4 질문별 즉답 연습"], ["19:00–21:00", "헬스·샤워·저녁"], ["21:30–21:55", "이번 주 강의의 회로·MCU 개념 복습"], ["21:55–22:05", "모르는 점과 확인할 것 기록"]],
  },
  {
    day: "목요일", type: "강의 기반 HW 실습", focus: "CAN·ECU 전에 기초를 직접 확인",
    events: [["출퇴근 30분", "토익스피킹 Part 5·6 의견 답변 녹음"], ["19:00–20:00", "저녁과 휴식"], ["20:00–21:10", "전동킥보드 강의 관련 회로·Firmware 실습"], ["21:10–21:30", "결과와 이해하지 못한 점 정리"], ["21:30–21:40", "다음 실습 행동 기록"]],
  },
  {
    day: "금요일", type: "회복·취업 Evidence", focus: "공부보다 정리와 회복",
    events: [["출퇴근 30분", "토익스피킹 미니 모의 1세트 녹음"], ["19:00–21:00", "헬스·샤워·저녁"], ["21:30–21:50", "녹음 1개 복기·막힌 표현 수정"], ["21:50–22:00", "취업 경험 또는 학습 결과 짧게 기록"], ["이후", "휴식"]],
  },
  {
    day: "토요일", type: "강의·HW 실습", focus: "강의 진도와 실제 결과물을 함께 확보",
    events: [["오전 60~90분", "전동킥보드 강의 2강과 핵심 내용 기록"], ["오후 2시간", "강의 관련 회로·Firmware·측정 실습"], ["저녁 45분", "토익스피킹 실전 모의 1회·녹음 복기"], ["20분", "사진·수치·결과를 취업 증거로 정리"]],
  },
] as const;
